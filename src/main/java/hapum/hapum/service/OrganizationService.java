...
//                photo.transferTo(destFile);
				Thumbnails.of(photo.getInputStream()).size(800, 800) // 최대 크기 제한 (비율 유지)
...
//                photo.transferTo(destFile);
	...
	public void updateOrganizationOrder(List<OrganizationOrderDto> orderList) {
		for (OrganizationOrderDto dto : orderList) {
			organizationMapper.updateSeq(dto);
		}
	}
